...
const STAPLE_MATCHES: Record<string, string> = {
  ...
  erdnussol: 'Erdnussöl',
  'bean sprouts': 'Sojabohnensprossen/Sojabohnenkeimlinge, roh',
  olivenol: 'Olivenöl',
  ...
  schlangengurke: 'Gurke roh',
  flusskrebsschwanze: 'Edelkrebs/Flusskrebs, roh',
  prosecco: 'Qualitätsschaumwein, Sekt, trocken',
  tortilla: 'Weizentortilla',
  tortillafladen: 'Weizentortilla',
  tortillas: 'Weizentortilla',
  wraps: 'Weizentortilla',
  wrap: 'Weizentortilla',
  fladenbrot: 'Weizenfladenbrot',
  apfel: 'Apfel roh',
  ananas: 'Ananas roh',
  'pork shoulder': 'Schwein Dicker Bug (mit Fett und Schwarte) roh',
  schweineschulter: 'Schwein Dicker Bug (mit Fett und Schwarte) roh',
